...
*   The *Templates folder location* should point to the folder where your templates reside (I recommend you keep these in a separate *Templates* folder, but you don't have to. There's more information on templates, see [Using Templates in Obsidian](/posts/760291368fdef77872894cab886b0946c61b8242).)
...
*(For more recommended plugins, check out [A Few of Our Favorite Obsidian Plugins](/posts/a8d2cf6481ab0d861eafda52a0d102ed4b1a7feb).)*
